...
public class HtmlGenerator {
    ...
    String generateHtml(LineList lines) {
        ...
        for (int lineNumber = 0; lineNumber < lines.getLines().size(); lineNumber++) {
            ...
            mSpans.add(new Span(Span.HTML, "<td class='line-number'>" + lineNumber + "</td><td class='code-line'>"));
            ...
            if (cursor.mLine != lineNumber) {
                ...
                mSpans.add(new Span(Span.CURSOR, "<span class='cursor-container'><span id='cursor'></span></span>"));
                mSpans.add(new Span(Span.RAW, line.getCode()));
        ...
        // Create final HTML
        mSpans.add(new Span(Span.HTML, "</table>\n" +
                "\n" +
                "<script>\n" +
    ...
    private class Span {
        ...
        static final int LINE_START = 10;
        static final int LINE_END = 11;
